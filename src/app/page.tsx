    ...
    <main className="bg-slate-50 min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-auto z-10">
        <div className="bg-white/70 backdrop-blur-lg border border-white/40 rounded-xl p-8 shadow-sm flex flex-col items-center">
          ...
          >
            <div className="flex justify-center w-full" aria-label="Grup Input OTP">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex gap-2">
                  {[0, 1, 2].map((i) => (
                    <div
                      key={i}
                      className="w-12 h-14 text-xl font-semibold bg-white border border-slate-200 rounded-xl flex items-center justify-center text-slate-900 shadow-sm"
                    >
                      {pin[i] ? "•" : ""}
                    </div>
                  ))}
