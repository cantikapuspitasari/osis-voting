    ...
    <main className="pt-20 md:pt-8 px-4 md:px-8 pb-24 md:pb-8 w-full grow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl p-6 shadow-sm shadow-slate-200/50">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-sm font-medium text-slate-500">Total Turnout</h3>
          ...
          <p className="text-xs font-medium text-slate-500 mt-3">1,254 of 1,600 registered</p>
        </div>

        {/* Card 2: Pending Votes */}
        <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl p-6 shadow-sm shadow-slate-200/50">
          <div className="flex justify-between items-start mb-4">
            <h3 className="text-sm font-medium text-slate-500">Pending Votes</h3>
            <div className="bg-amber-50 p-2 rounded-lg text-amber-600">
              <Clock className="w-5 h-5" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-slate-900 tracking-tight">346</span>
          </div>
      ...
      <div className="bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl p-6 shadow-sm shadow-slate-200/50 mb-8 h-96 flex flex-col">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-lg font-bold text-slate-900">Real-Time Vote Count</h2>
        ...
        <div className="flex-1 flex items-end justify-around gap-4 pb-4 border-b border-slate-100 relative mt-4">
          ...
          <div className="ml-10 w-full flex justify-around items-end h-full">
            ...
            <div className="flex flex-col items-center group w-1/4 h-full justify-end relative">
              ...
              <span className="mt-4 text-xs font-bold text-slate-600 truncate w-full text-center">Paslon 01</span>
            </div>
            ...
            <div className="flex flex-col items-center group w-1/4 h-full justify-end relative">
              ...
              <span className="mt-4 text-xs font-semibold text-slate-500 truncate w-full text-center">Paslon 02</span>
            </div>
            ...
            <div className="flex flex-col items-center group w-1/4 h-full justify-end relative">
              ...
              <span className="mt-4 text-xs font-semibold text-slate-500 truncate w-full text-center">Paslon 03</span>
            </div>
          </div>
        </div>
      </div>
