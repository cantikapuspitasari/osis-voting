...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative z-0 selection:bg-blue-100 selection:text-blue-900">
      ...
      >
        <div className="absolute w-[60vh] h-[60vh] bg-[radial-gradient(circle,#DBEAFE_0%,rgba(255,255,255,0)_70%)] rounded-full top-[-10vh] right-[10vw] opacity-50"></div>
        <div className="absolute w-[50vh] h-[50vh] bg-[radial-gradient(circle,#BFDBFE_0%,rgba(255,255,255,0)_70%)] rounded-full bottom-[-5vh] left-[15vw] opacity-30"></div>
      </div>
      ...
      <main className="w-full max-w-md mx-auto flex flex-col gap-8 relative z-10">
        <header className="flex flex-col items-center justify-center gap-4 text-center pb-2">
          ...
          <div className="flex flex-col gap-1">
            <h1 className="text-2xl font-bold text-blue-600 tracking-tight">OSIS Portal</h1>
            <p className="text-sm text-slate-500">Secure Administrator Access</p>
          </div>
        </header>
        ...
        <div className="bg-white/70 backdrop-blur-lg border border-white/40 rounded-[20px] p-8 shadow-sm flex flex-col gap-6 relative overflow-hidden">
          <form onSubmit={handleAdminLogin} className="flex flex-col gap-5 relative z-10">
