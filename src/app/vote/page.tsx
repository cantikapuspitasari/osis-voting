...
const candidates: Candidate[] = [
  {
    ...
    chairman: {
      name: "Budi Santoso",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBF4yz-2Hg14G5ghwaPHuvcBPy9lzSUEw1X1w5UitJDoJwc3svk3MxmyLUCtE6lRKH5JrcTpwQIxwXNbLjK1BjDnfDONhzQcfI-S5-ozejHmxiKTm2XVELX5IJASw_xXLp5NV9VJNGaOHtzdJf9cEJ7bmN0AqfEsCKADOo1qhFhgK8IuM8imLlT0PxavO6cj59dmA793z8BYBC_McDJOg4I-jJp3XRvdzmh_6RpZYeII_CjrllqO5vLtkQ6HjUiesiGn0UDOjD_4",
    },
    viceChairman: {
      name: "Siti Aminah",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDR5maEPaY_jttl_CXcDPbV4r4J5j9LRaUrPQdt14bVwJ4S8AB_Lv2Vb4zBkCXYZebdYVCvwL_H8qYbdnhMKdd4lai6ZQXL5lo5reUK5bDez97H-4ySjNN38v8x6tmxwmxNs7Sb72uHH5aqO-abZQ_eS7PfqW8KallEDB_g5TIXVGhP9KRzGJdyvn_0NF2o4xae-s5zj3WViHqxI7_9OUY93ZeksdYbJy9KjoXsA8bdNm422jcASC1ojXbM-M8Ep3Aph5m65Tew",
    },
    vision:
  ...
  },
  {
    ...
    chairman: {
      name: "Agus Wijaya",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCQepcwlSJszsUU9xou83pUdn1WAk8IYov5pV0hzgeXB8JDcQB6peh20QoK75Egh5MGqo4VUjf6s_mI8tTfKCjGqyn6CTFTiqXMb5DgTkX2cRjFgcMZB_AsJO4uIRIlJ-lgug1Deh1Z8ma6YNgQyWC42mx5F8-uBxZOljBFN2rbdTaTNyJTXITiUI526nuroFlqnAJ4PEoz5kbgY5gVmmZ_8RJHZviBWZZq1VcKp_Kd8CgY1qBrFW4qC8EoCv9DKSAXV-4XBV5vs",
    },
    viceChairman: {
      name: "Dian Kusuma",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCbqV9vjTP24cAu4wte0NSfRMUV_iLm4Yf_cnKijseOqHzeiCOeLaA446QfZztI_EpL_OJ9zYpkNL2KvjtfECeKmtCiC4S6AAqyeVlcuHf_SAoO8GPDXMbn_4xN3RXF4gOOGqiLQIbU2Mi02ihlbFBrmaOh4YztVvfzyNQDoq8dkZoTQ4DsntfoCTCCPvELHlH9nvonDjwfO4R8dZrjpT1iM0CcEPpal2ZBly1FNyF2t7igLAgo0t85AEOridcQnYBceMh2uSHI",
    },
    vision:
  ...
  },
  {
    ...
    chairman: {
      name: "Rendi Pratama",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAak9GV81Cwqsg0woVNmaHrdylCQaONvYHPXtufTXVKWIov6JH7JBE4WSDJ6QU06aoD58hFcV_VkpHZealEa3vJ9K6KpaUzNJHpRSY62H8dO3EWXcaHl8wNBUajLjc5ect7k7_PvIRbC1bwhOZ67XTadVSAxxnFEaeRK5o8UeetOaSplJl4OhiCeaweBl56GBDfDTITpQtM09U0wkwj4l9HCHaMAQ53O5FQhMu1nst3p2j6Ax5oJF7sGMQu4TeNCXIMJLlNMxVmo",
    },
    viceChairman: {
      name: "Siti Nurhaliza",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuB3L1IvYpD6RVz_hc0YH_e792BfJHsvCchT4juVVIBCcTHui4Pg_eJ83ApvBzE61ZLrv_fNPm30ydMs_uMLFd8QsbyTsYMhKvLcwmjJqXMqUWYholUkIKNugwuRu2MnxyqzV7KLqzkcBUocJBUgMg514lYjJ-YAP51Ly6Ge7Uz2xwW0WTnQPQ31j0hzIxe-eh5znwog4RAg4nw6CP4uuUnDgY2NByfRGTHZA1f9PgQMM2AkCJu9SMWY_DL_2xStfjbmvLFE64Ho",
    },
          ...
          <div className="relative w-full max-w-md bg-white/90 backdrop-blur-lg border border-white/40 rounded-xl p-6 shadow-xl shadow-blue-500/20 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium active:scale-[0.98] transition-transform duration-200 shadow-md shadow-blue-500/20 flex items-center justify-center gap-2"
              >
                Ya, Saya Yakin
              ...
              <button
                onClick={() => setIsConfirmOpen(false)}
                className="w-full py-4 bg-transparent border-2 border-blue-600 text-blue-600 hover:bg-blue-50 rounded-xl font-medium active:scale-[0.98] transition-transform duration-200"
              >
                Batal
              </button>
            </div>
